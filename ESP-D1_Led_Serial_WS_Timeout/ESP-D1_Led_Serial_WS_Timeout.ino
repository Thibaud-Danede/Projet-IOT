...
*  http://server_ip/gettemp will send temperature page.
*  
* Board : ESP-D1  
...
IPAddress WS_local_IP(192,168,1,166);
...
void setup() {
  ...
  // Wait while connecting or TimeOut
  timeout.start(TIMEOUT);
  while ((WiFi.status() != WL_CONNECTED)&&(!timeout.time_over())) {
    delay(500);
    Serial.print(".");
  }
  Serial.println("");

  // Test Connected or TimeOut
